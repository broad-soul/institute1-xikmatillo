<template>
  ...
  >
    <q-page class="contests__show__page">
      <div class="row q-pa-md q-col-gutter-md justify-center">
        <div class="col-11">
          <q-img placeholder-src="/statics/photo2.png" :ratio="16/9" :src="'/storage/' + contests.image"></q-img>
        </div>
        <div class="col-11 py-5">
          <h3>{{contests['title_' + $t('prefix')]}}</h3>
          <div class="content" v-html="contests['content_' + $t('prefix')]"></div>
        </div>
      </div>
