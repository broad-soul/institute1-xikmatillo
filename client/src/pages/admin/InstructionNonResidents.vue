    ...
    <q-page class="page__residents">
      <div class="q-pa-md">
        <q-breadcrumbs  active-color="teal">
          ...
          <q-breadcrumbs-el label="NonResidents" to="/admin/non-residents" />
...
export default {
  ...
  methods: {
    saveInstruction () {
      ...
      this.loading = true
      this.$axios.post('update_non_resident_instruction', this.instruction_app).then(() => {
        this.$q.notify({
          color: 'teal',
          icon: 'check_circle',
          message: 'Success',
        ...
        this.$router.push('/admin/non-residents')
