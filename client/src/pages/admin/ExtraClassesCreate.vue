    ...
    <q-page class="admin__main">
      <div class="q-pa-md">
         <q-breadcrumbs  active-color="teal">
          ...
          <q-breadcrumbs-el label="Extra-Classes" to="/admin/extra-classes" />
      ...
      <div class="q-pa-md q-gutter-y-md">
        <q-card class="q-pa-md q-gutter-y-md">
          ...
          >
            ...
            <q-btn :disable="loading" to="/admin/ExtraClasses">Cancel</q-btn>
          </q-form>
        </q-card>
      </div>
    </q-page>
...
export default {
  ...
  methods: {
    createPartners () {
      ...
      this.$axios.post('create_extra-classes', formData).then(() => {
        this.$q.notify({
          color: 'teal',
          icon: 'check_circle',
